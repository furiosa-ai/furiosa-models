...
@pytest.mark.parametrize("test_image_path,expected_batch_axis,expected_zero_index_detected_box", 
                         [("tests/assets/yolov5-test.jpg", 2, 18)])
@pytest.mark.asyncio
async def test_yolov5_small(session_test_senario: str, test_image_path: str, expected_batch_axis: int, expected_zero_index_detected_box: int):
