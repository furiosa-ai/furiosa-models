...
from .common.datasets import coco, dataset
...
async def mlcommons_resnet50():
    return ResNet50(
        ...
        model=await loader.read("furiosa/artifacts/vision/mlcommons_resnet50_v1.5_int8.onnx"),
    )
...
async def mlcommons_ssd_mobilenet():
    return SSDSmall(
        ...
        model=await loader.read("furiosa/artifacts/vision/mlcommons_ssd_mobilenet_v1_int8.onnx"),
    )
...
async def mlcommons_ssd_resnet34():
    return SSDLarge(
        ...
        model=await loader.read("furiosa/artifacts/vision/mlcommons_ssd_resnet34_int8.onnx"),
    )
